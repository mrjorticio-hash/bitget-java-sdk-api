...
public class MixMarketService {
    ...
    public ResponseResult fundingRates(Map<String,String> paramMap) throws IOException {
        return ResponseUtils.handleResponse(mixMarketApi.fundingRates(paramMap).execute().body());
    }

    public ResponseResult historyFundingRates(Map<String,String> paramMap) throws IOException {
        return ResponseUtils.handleResponse(mixMarketApi.historyFundingRates(paramMap).execute().body());
    }
}
